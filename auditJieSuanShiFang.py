...
if __name__ == '__main__':
    ...
    for activeDate in activeDateList:
        for customerName in customerNameList:
            ...
            sql05 = "SELECT sn ,activeDate FROM d_device_activate_detail WHERE LEFT(activeDate,7) >= '2017-11' and LEFT(activeDate,7) <= %s and customer_name = '调剂用' and sn not in (SELECT sn FROM d_settle_doc_big_customer_copy) group by sn order by activeDate desc ;"
