...
if __name__ == '__main__':
    ...
    for detailData in activateDetailData:
        for customerData in bigCustomerData:
            if customerData is None or detailData is None:
                pass
            elif customerData[1] == detailData[1] and int(customerData[4]) > 0:
                print(num)
                ...
                cursor.execute(sql03,
                               [strField[1], strField[2], strField[3], strField[4], strField[5], strField[6],
                                strField[7],
                                strField[8], strField[9], strField[10]])
                if int(customerData[5]) > 0:
                    ...
                    cursor.execute(sql04,
                                   [strField[11], strField[12], strField[13], strField[14], strField[15], strField[16],
                                    strField[17]])
                num = num + 1
