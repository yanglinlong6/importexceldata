...
if __name__ == '__main__':
    ...
    sql = '''
    TRUNCATE TABLE t_platform_device_yll_0221;
    '''
    cursor.execute(sql)
    print('清理临时操作记录数据库')
    ...
    for deviceType in deviceTypeList:
        sql00 = '''
        SELECT settle_date ,customer_id ,settle_count ,device_type ,specific_version  FROM openplatform_settle_list where device_type = %s and settle_count >= 0;   
        '''
        ...
        for openPlatformSettle in openPlatformSettleList:
            ...
            for index in range(openPlatformSettle[2]):
                ...
                sql02 = '''
                      INSERT INTO t_platform_device_yll_0221
