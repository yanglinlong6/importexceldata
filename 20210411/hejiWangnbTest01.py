...
if __name__ == '__main__':
    ...
    if dateType[1] in customerTypeList:
        ...
        sql01 = '''
                    select sn from d_settle_doc_big_customer_yll0401_03 WHERE customer_type = %s and DATE_FORMAT(DATE_SUB(settle_date, INTERVAL 1 MONTH),'%%Y%%m') = %s 
        ...
        sql02 = '''
                    ...
                    and sn not in (select sn from d_settle_doc_big_customer_yll0401_03 WHERE customer_type = %s and DATE_FORMAT(DATE_SUB(settle_date, INTERVAL 1 MONTH),'%%Y%%m') = %s );	
                    '''
